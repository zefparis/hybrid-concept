    ...
    sections: [
      {
        ...
        links: [
          ...
          { label: 'HCS-U7 Cybersecurity', href: '/sectors/cyber-resilience' },
...
export const SECTORS: Sector[] = [
  ...
  },
  {
    ...
    title: 'HCS-U7 Cognitive Cybersecurity',
    shortTitle: 'HCS-U7',
    description: 'Patented cognitive authentication with 11-layer anti-mimicry, Brain ML, and post-quantum cryptography',
    longDescription:
      'HCS-U7 is a patented cognitive authentication platform that proves human identity through multi-domain cognitive challenges, autonomous machine learning (Brain ML v2.0), 11-layer anti-mimicry detection, and post-quantum cryptography — delivering 99.5% attack rejection with zero exploitable vulnerabilities.',
    icon: 'cyber',
    capabilities: ['hybrid-cyber', 'hybrid-vector', 'hybrid-nexus'],
    challenges: [
      'AI bot mimicry & credential stuffing',
      'Quantum computing threats to cryptography',
      'Replay & injection attacks at scale',
      'Adaptive adversarial AI evasion',
    ],
    outcomes: [
      '99.5% attack rejection rate — zero exploitable vulnerability',
      '<1ms ML inference with Docker-isolated workers',
      '<19-minute automated remediation for critical vulnerabilities',
    ],
    metadata: {
      title: 'HCS-U7 Cognitive Cybersecurity | Patented Human Authentication',
      description:
        'HCS-U7: patented cognitive authentication with 11-layer anti-mimicry, Brain ML v2.0, and post-quantum cryptography. 99.5% attack rejection rate.',
      keywords: ['cognitive authentication', 'anti-mimicry', 'post-quantum cryptography', 'Brain ML', 'HCS-U7', 'human authentication', 'bot detection'],
    },
  },
  {
    id: 'sector-ai',

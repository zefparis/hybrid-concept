...
export function ProductCTA({
  ...
  return (
    <section className="py-16 sm:py-20 md:py-32 px-4 sm:px-6 md:px-12 bg-surface">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-2xl sm:text-3xl md:text-display-md font-bold mb-6 wrap-break-word">
          {title}
        </h2>
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center">
          <Button href={finalPrimary} size="lg" className="w-full sm:w-auto">
            {primaryLabel}
          </Button>
          <Button href={finalSecondary} size="lg" variant="outline" className="w-full sm:w-auto">
            {secondaryLabel}
          </Button>
        </div>
      </div>
